...
if (typeof window === 'undefined' || typeof document === 'undefined' || typeof window.document === 'undefined') throw new Error(`Missing scopes...  'window': ${typeof window !== 'undefined'} , 'window.document':  ${typeof window.document !== 'undefined'}, 'document':  ${typeof document !== 'undefined'}`);
